...
/**
 * Entity listener which allows dependency injection inside entities. The listener can be registered
 * via {@link EntityListeners} annotation.
 *
 * <p>Dependency injection annotations like {@link Autowired} are supported.
 *
 * <p>Example:
 *
 * <pre>
