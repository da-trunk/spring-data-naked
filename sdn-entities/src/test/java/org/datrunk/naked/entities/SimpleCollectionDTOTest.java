...
@SpringBootTest(
    classes = SimpleCollectionDTOTest.Config.class,
...
public class SimpleCollectionDTOTest {
  ...
  protected interface Type {
    ...
    public default String getTypeId() {
      ...
      if (type != Object.class) return type.getTypeName();
      else return getClass().getTypeName();
    }
  }
  ...
  public static class Parent implements Type {
    ...
    @NonNull private List<Child> children;
