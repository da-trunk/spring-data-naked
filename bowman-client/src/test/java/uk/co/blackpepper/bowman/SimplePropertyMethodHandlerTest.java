...
public class SimplePropertyMethodHandlerTest {
  ...
  public void supportsWithGetMethodWithParameterIsFalse() {
    assertThat(
        handler.supports(findMethod(ResourceContent.class, "getThing3", int.class)), is(false));
  }
  ...
  public void supportsWithSetterIsTrue() {
    assertThat(
        handler.supports(findMethod(ResourceContent.class, "setThing", String.class)), is(true));
  }

  @Test
  public void supportsWithSetMethodWithParameterIsFalse() {
    assertThat(
        handler.supports(findMethod(ResourceContent.class, "setThing2", String.class, int.class)),
        is(false));
  }
  ...
  public void supportsWithSetMethodWithReturnTypeIsFalse() {
    assertThat(
        handler.supports(findMethod(ResourceContent.class, "setThing3", String.class)), is(false));
  }
