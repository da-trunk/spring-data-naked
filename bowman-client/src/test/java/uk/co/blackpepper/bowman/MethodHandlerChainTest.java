...
public class MethodHandlerChainTest {
  ...
  public void invokeInvokesFirstSupportedDelegate() throws Throwable {
    ...
    MethodHandlerChain chain =
        new MethodHandlerChain(
            asList(
                newHandlerUnsupportedFor(method), expectedHandler, newHandlerSupportedFor(method)));
    ...
    verify(expectedHandler)
        .invoke(eq(self), eq(method), eq(proceedMethod), argThat(arrayContaining(arg)));
  }
  ...
  public void isHandledWithNoDelegateSupportsIsFalse() throws Exception {
    ...
    MethodHandlerChain chain =
        new MethodHandlerChain(singletonList(newHandlerUnsupportedFor(method)));
  ...
  public void isHandledWithDelegateSupportsIsTrue() throws Exception {
    ...
    MethodHandlerChain chain =
        new MethodHandlerChain(singletonList(newHandlerSupportedFor(method)));
