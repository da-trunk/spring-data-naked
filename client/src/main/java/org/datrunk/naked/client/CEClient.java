...
public class CEClient<T extends WithUri & WithId> extends Client<T> {
    ...
    protected CEClient(Class<T> entityType, String batchPath, Configuration bowmanConfiguration, RestOperations restOperations, ClientProxyFactory proxyFactory) {
    ...
    protected CEClient(Class<T> entityType, URI batchUri, Configuration bowmanConfiguration, RestOperations restOperations, ClientProxyFactory proxyFactory) {
    ...
    public CollectionModel<EntityModel<T>> saveAll(CollectionDTO<T> wrapped) {
        ...
        JavaType innerType = objectMapper.getTypeFactory()
                                         .constructParametricType(EntityModel.class, entityType);
