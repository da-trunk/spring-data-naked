...
public class MethodLinkUriResolverTest {
  ...
  public void resolveForMethodWithNoMatchingLinkThrowsException() {
    EntityModel<Object> resource =
        EntityModel.of(new Object(), Links.of(Link.of("http://www.example.com", "other")));
  ...
  public void resolveForMethodReturnsUriWithParamsExpanded() {
    EntityModel<Object> resource =
        EntityModel.of(new Object(), Links.of(Link.of("http://www.example.com/{?x,y}", "link1")));

    URI uri =
        new MethodLinkUriResolver().resolveForMethod(resource, "link1", new Object[] {"1", 2});
