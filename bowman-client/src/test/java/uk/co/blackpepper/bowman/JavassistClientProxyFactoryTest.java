...
public class JavassistClientProxyFactoryTest {
  ...
  public void createReturnsProxyWithId() {
    EntityModel<Entity> resource =
        EntityModel.of(new Entity(), Link.of("http://www.example.com/1", IanaLinkRelations.SELF));
  ...
  public void createReturnsProxyWithLinkedResource() {
    EntityModel<Entity> resource =
        EntityModel.of(
            new Entity(), Link.of("http://www.example.com/association/linked", "linked"));

    when(restOperations.getResource(
            URI.create("http://www.example.com/association/linked"), Entity.class))
        .thenReturn(
            EntityModel.of(
                new Entity(), Link.of("http://www.example.com/1", IanaLinkRelations.SELF)));
  ...
  public void createReturnsProxyWithLinkedResourceWithCustomRel() {
    EntityModel<Entity> resource =
        EntityModel.of(new Entity(), Link.of("http://www.example.com/association/linked", "a:b"));
  ...
  public void createReturnsProxyWithLinkedResources() {
    EntityModel<Entity> resource =
        EntityModel.of(
            new Entity(), Link.of("http://www.example.com/association/linked", "linkedCollection"));

    when(restOperations.getResources(
            URI.create("http://www.example.com/association/linked"), Entity.class))
        .thenReturn(
            CollectionModel.of(
                asList(
  ...
  public void createWithNullLinkedCollectionReturnsProxyWithLinkedResources() {
    ...
    assertThat(
        proxy.getNullLinkedCollection().get(0).getId(), is(URI.create("http://www.example.com/1")));
  }
  ...
  public void createReturnsProxyWithActive() {
    ...
    EntityModel<Entity> resource =
        EntityModel.of(entity, Link.of("http://www.example.com/1", IanaLinkRelations.SELF));
  ...
  public void createWithResourceWithProxiedAbstractClassContentReturnsProxy() throws Exception {
    AbstractClassTypeResource content =
        instantiateProxyOfAbstractClassType(AbstractClassTypeResource.class);

    AbstractClassTypeResource resource =
        proxyFactory.create(EntityModel.of(content), mock(RestOperations.class));

    assertThat(
        resource, is(allOf(isA(AbstractClassTypeResource.class), not(sameInstance(content)))));
  }
  ...
  public void createWithResourceWithProxiedInterfaceContentReturnsProxy() throws Exception {
    ...
    InterfaceTypeResource resource =
        proxyFactory.create(EntityModel.of(content), mock(RestOperations.class));
  ...
  @Test
  public void createWithResourceWithProxiedInterfaceContentReturnsProxyWithLinkedResources()
      throws Exception {
    InterfaceTypeResource content = instantiateProxyOfInterfaceType(InterfaceTypeResource.class);
    ...
    InterfaceTypeResource resource =
        proxyFactory.create(
            EntityModel.of(content, Link.of("http://www.example.com/association/linked", "linked")),
            restOperations);
  ...
  public void createWithUnconstructableEntityResourceThrowsException() {
    ...
    proxyFactory.create(
        EntityModel.of(new UnconstructableEntity(new Object())), mock(RestOperations.class));
  }
