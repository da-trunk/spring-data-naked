...
public class RestOperationsFactoryTest {
  ...
  @Test
  public void
      createInstantiatesObjectMapperWithInlineAssociationDeserializerAwareHandlerInstantiator() {
    ObjectMapper mapper = new ObjectMapper();
    RestTemplate restTemplate = new RestTemplate();
    ...
    ArgumentCaptor<HandlerInstantiator> handlerInstantiator =
        ArgumentCaptor.forClass(HandlerInstantiator.class);
    ...
    assertThat(
        result,
        is(
            anInlineAssociationDeserializerMatching(
  ...
  public void createInstantiatesObjectMapperWithResourceDeserializerAwareHandlerInstantiator() {
    ...
    JsonDeserializer<?> result =
        handlerInstantiator.getValue().deserializerInstance(null, null, ResourceDeserializer.class);

    assertThat(
        result,
        is(
            aResourceDeserializerMatching(
                instanceOf(DefaultTypeResolver.class), is(configuration))));
  }

  @Theory
  public void createInstantiatesObjectMapperWithNonLibraryHandlerAwareHandlerInstantiator(
      @ParametersSuppliedBy(NonLibraryHandlerTestParams.class)
          HandlerInstantiatorTestParams params) {
  ...
  public void createInvokesConfigurerOnRestTemplateIfPresent() {
    ...
    Configuration configuration =
        Configuration.builder().setRestTemplateConfigurer(restTemplateConfigurer).build();
  ...
  public void createInvokesConfigurerOnObjectMapperIfPresent() {
    ...
    Configuration configuration =
        Configuration.builder().setObjectMapperConfigurer(objectMapperConfigurer).build();
  ...
  private static Matcher<RestOperations> aRestOperationsMatching(
      Matcher<RestTemplate> restTemplate, Matcher<ObjectMapper> mapper) {
    return new TypeSafeMatcher<RestOperations>() {
      ...
      public void describeTo(Description description) {
        description
            .appendText("restTemplate ")
            .appendValue(restTemplate)
            .appendText(", objectMapper ")
            .appendValue(mapper);
      }
    };
  }
    ...
    return new TypeSafeMatcher<JsonDeserializer>() {
      ...
      public void describeTo(Description description) {
        description
            ...
            .appendValue(InlineAssociationDeserializer.class)
            .appendText(", restOperations ")
            .appendValue(restOperations)
            .appendText(", proxyFactory ")
            .appendValue(proxyFactory);
      }
    };
  }
  ...
  private static Matcher<JsonDeserializer> aResourceDeserializerMatching(
    ...
    return new TypeSafeMatcher<JsonDeserializer>() {
      ...
      public void describeTo(Description description) {
        description
            .appendText("instanceof ")
            .appendValue(ResourceDeserializer.class)
            .appendText(", typeResolver ")
            .appendValue(typeResolver)
            .appendText(", configuration ")
            .appendValue(configuration);
      }
    };
  }
  ...
  private static class HandlerInstantiatorTestParams {
    ...
    HandlerInstantiatorTestParams(
        Class<?> clazz, BiFunction<HandlerInstantiator, Class<?>, Object> instantiationMethod) {
    ...
    public List<PotentialAssignment> getValueSources(ParameterSignature sig) {
      return asList(
          PotentialAssignment.forValue(
              ...
              new HandlerInstantiatorTestParams(
                  DummyJsonDeserializer.class,
                  (instantiator, clazz) -> instantiator.deserializerInstance(null, null, clazz))),
          PotentialAssignment.forValue(
              "keyDeserializerInstance",
              new HandlerInstantiatorTestParams(
                  DummyKeyDeserializer.class,
                  (instantiator, clazz) ->
                      instantiator.keyDeserializerInstance(null, null, clazz))),
          PotentialAssignment.forValue(
              "serializerInstance",
              new HandlerInstantiatorTestParams(
          ...
          PotentialAssignment.forValue(
              ...
              new HandlerInstantiatorTestParams(
                  DummyTypeResolverBuilder.class,
                  (instantiator, clazz) ->
                      instantiator.typeResolverBuilderInstance(null, null, clazz))),
          PotentialAssignment.forValue(
              "typeIdResolverInstance",
              new HandlerInstantiatorTestParams(
                  DummyTypeIdResolver.class,
                  (instantiator, clazz) ->
                      instantiator.typeIdResolverInstance(null, null, clazz))));
    }
  }
