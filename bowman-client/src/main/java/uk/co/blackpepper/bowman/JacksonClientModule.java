 ...
 *
 * <p>Registering this module with an {@link com.fasterxml.jackson.databind.ObjectMapper} will cause
 * properties annotated with {@link LinkedResource} to be serialized as URI strings (single-valued
 * associations) or arrays of URI strings (collection-valued associations), and properties of type
 * {@link javassist.util.proxy.MethodHandler} to not be serialized.
 *
 * @author Ryan Pickett
 */
