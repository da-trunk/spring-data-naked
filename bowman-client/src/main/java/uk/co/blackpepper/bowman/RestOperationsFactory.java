...
public class RestOperationsFactory {
	...
	public RestOperationsFactory(Configuration configuration, ClientProxyFactory proxyFactory, ObjectMapperFactory objectMapperFactory, RestTemplateFactory restTemplateFactory) {
