...
public final class Configuration {
  ...
  public static final class Builder {
     ...
     *
     * <p>Collection resource paths specified on entity classes with {@link
     * uk.co.blackpepper.bowman.annotation.RemoteResource} annotations will be resolved relative to
     * this URI.
     *
    ...
    /**
     * Set the <code>RestTemplateConfigurer</code> for the created configuration. Allows further
     * configuration of the Spring <code>RestTemplate</code> used internally.
     *
     ...
     *
     * <p><b>N.B.</b> this MUST be an implementation that throws a {@link
     * org.springframework.web.client.HttpClientErrorException} when a HTTP 404 is returned
     * accessing the remote resource, as this fact is used internally to distinguish between empty
     * results and other client error conditions. The Spring implementations that satisfy this
     * requirement are {@link
     * org.springframework.http.client.HttpComponentsClientHttpRequestFactory}, and any wrapping
     * implementations delegating to this.
     *
    ...
    /**
     * Set the <code>ObjectMapperConfigurer</code> for the created configuration. Allows further
     * configuration of the Jackson <code>ObjectMapper</code> used internally.
     *
