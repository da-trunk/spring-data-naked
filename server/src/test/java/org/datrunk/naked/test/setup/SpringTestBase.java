    ...
    public static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext ctx) {
            if (instance == null) {
                ...
                /*
                 * String v1User = ctx.getEnvironment() .getProperty("spring.secondary-datasource.username"); String v1Password =
                 * ctx.getEnvironment() .getProperty("spring.secondary-datasource.password");
                 */
            ...
            // TestPropertySourceUtils.addInlinedPropertiesToEnvironment(ctx, "spring.secondary-datasource.url=" + instance.getJdbcUrl());
