 ...
 *
 * <p>Only one of {@link #subtypes} or {@link #typeResolver} should be specified.
 *
 * @author Ryan Pickett
 */
...
public @interface ResourceTypeInfo {
   ...
   * deserialization, the final type of the property (or property collection item) will be
   * determined by the self link of the resource.
   *
