 ...
 */
public class ReplacingInputStream3 extends FilterInputStream {
     ...
     */
    public static InputStream newLineNormalizingInputStream(InputStream is) throws UnsupportedEncodingException {
        return new ReplacingInputStream(new ReplacingInputStream(is, "\n\r", "\n"), "\r", "\n");
    }

    /**
     * Replace occurances of pattern in the input. Note: input is assumed to be UTF-8 encoded. If not the case use byte[] based pattern and
     * replacement.
     * 
     * @param in input
     ...
     */
    public ReplacingInputStream3(InputStream in, String pattern, String replacement) {
     ...
     * @param replacement the replacement or null
     */
    public ReplacingInputStream3(InputStream in, byte[] pattern, byte[] replacement) {
        super(in);
        assert (pattern != null);
