...
public class FunctionalClientException extends RuntimeException {
  ...
  public static class DTO implements Serializable {
    ...
    public static DTO of(final ClientHttpResponse response, final ObjectMapper mapper)
        throws IOException {
  ...
  public FunctionalClientException(ClientHttpResponse response, ObjectMapper mapper)
      throws IOException {
    super(DTO.of(response, mapper).getMessage());
