...
public class ResourceDeserializerTest {
  ...
  public void deserializeResolvesType() throws Exception {
    mapper.readValue(
        "{\"_links\":{\"self\":{\"href\":\"http://x.com/1\"}}}",
        new TypeReference<EntityModel<DeclaredType>>() {
    ...
    verify(typeResolver)
        .resolveType(
            DeclaredType.class,
            Links.of(Link.of("http://x.com/1", IanaLinkRelations.SELF)),
            configuration);
  }
  ...
  public void deserializeReturnsObjectOfResolvedType() throws Exception {
    ...
    EntityModel<DeclaredType> resource =
        mapper.readValue(
            "{\"field\":\"x\"}",
            new TypeReference<EntityModel<DeclaredType>>() {
              /* generic type reference */
    ...
    assertThat(
        "class", resource.getContent().getClass(), Matchers.<Class<?>>equalTo(ResolvedType.class));
  ...
  public void deserializeReturnsObjectOfResolvedInterfaceType() throws Exception {
    ...
    assertThat(
        ResolvedInterfaceType.class.isAssignableFrom(resource.getContent().getClass()), is(true));
  }
  ...
  public void deserializeReturnsObjectOfResolvedAbstractClassType() throws Exception {
    ...
    assertThat(
        ResolvedAbstractClassType.class.isAssignableFrom(resource.getContent().getClass()),
        is(true));
  }
}
